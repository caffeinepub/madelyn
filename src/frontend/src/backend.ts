...
import type { Category as _Category, ExternalBlob as _ExternalBlob, Item as _Item, Time as _Time, _CaffeineStorageRefillInformation as __CaffeineStorageRefillInformation, _CaffeineStorageRefillResult as __CaffeineStorageRefillResult } from "./declarations/backend.did.d.ts";
export class Backend implements backendInterface {
    ...
    async addItem(arg0: string, arg1: Category, arg2: ExternalBlob | null): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.addItem(arg0, to_candid_Category_n8(this._uploadFile, this._downloadFile, arg1), await to_candid_opt_n10(this._uploadFile, this._downloadFile, arg2));
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async filterByCategory(arg0: Category): Promise<Array<Item>> {
        if (this.processError) {
            try {
                const result = await this.actor.filterByCategory(to_candid_Category_n8(this._uploadFile, this._downloadFile, arg0));
    ...
    async getItem(arg0: string): Promise<Item> {
        if (this.processError) {
            try {
                ...
                return from_candid_Item_n13(this._uploadFile, this._downloadFile, result);
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
            }
    ...
    async sortBooksByYear(): Promise<Array<Item>> {
        if (this.processError) {
            try {
                const result = await this.actor.sortBooksByYear();
                return from_candid_vec_n12(this._uploadFile, this._downloadFile, result);
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
...
async function from_candid_Item_n13(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: _Item): Promise<Item> {
...
async function from_candid_vec_n12(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: Array<_Item>): Promise<Array<Item>> {
    return await Promise.all(value.map(async (x)=>await from_candid_Item_n13(_uploadFile, _downloadFile, x)));
}
...
function to_candid_variant_n9(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: {
    ...
    return value.__kind__ === "Tin" ? {
        Tin: value.Tin
    } : value.__kind__ === "Book" ? {
        Book: value.Book
    } : value.__kind__ === "Patch" ? {
        Patch: value.Patch
    } : value.__kind__ === "Uniform" ? {
        Uniform: value.Uniform
    } : value;
}
